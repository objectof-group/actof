...
public class ICompositeTemplate extends ITemplate<IKind<?>>implements Facet<IKind<?>> {
    ...
    protected Writer defineWriter(IKind<?> aKind) throws IOException {
        ...
        dir.mkdirs();
        String fileName = 'I' + Util.initCap(Util.selector(aKind.getComponentName())) + "Bean.java";
