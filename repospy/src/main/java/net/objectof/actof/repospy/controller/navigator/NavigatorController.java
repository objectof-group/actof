package net.objectof.actof.repospy.controller.navigator;
...
import net.objectof.actof.repospy.controller.navigator.composite.CompositeTreeItem;
import net.objectof.actof.repospy.controller.navigator.composite.CompositeTreeTableCell;
...
public class NavigatorController extends IActofUIController {
    ...
    private void onChange(Change change) {
        ...
        Image image;
        if (!hasHistory) {
            image = new Image(RepoSpy.class.getResourceAsStream("view/icons/refresh.png"));
            revert_image.setImage(image);
            revert_tooltip.setText("Refresh from repository");
        } else {
            image = new Image(RepoSpy.class.getResourceAsStream("view/icons/revert.png"));
            revert_image.setImage(image);
